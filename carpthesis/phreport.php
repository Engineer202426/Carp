...
if ($fromDate && $toDate) {
    $sql = "SELECT UNIX_TIMESTAMP(ph_create)*1000 as x, ph_value as y FROM phsensor WHERE DATE(ph_create) BETWEEN '$fromDate' AND '$toDate'";
} else {
    $sql = "SELECT UNIX_TIMESTAMP(ph_create)*1000 as x, ph_value as y FROM phsensor";
}
