...
if ($fromDate && $toDate) {
    $sql = "SELECT UNIX_TIMESTAMP(tds_create)*1000 as x, tds_value as y FROM tdssensor WHERE DATE(tds_create) BETWEEN '$fromDate' AND '$toDate'";
} else {
    $sql = "SELECT UNIX_TIMESTAMP(tds_create)*1000 as x, tds_value as y FROM tdssensor";
}
