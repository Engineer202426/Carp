...
if ($fromDate && $toDate) {
    $sql = "SELECT UNIX_TIMESTAMP(do_create)*1000 as x, do_value as y FROM dosensor WHERE DATE(do_create) BETWEEN '$fromDate' AND '$toDate'";
} else {
    $sql = "SELECT UNIX_TIMESTAMP(do_create)*1000 as x, do_value as y FROM dosensor";
}
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="input-group mb-3" style="width: 30%;">
                    <input type="date" class="form-control" id="fromDatepicker" placeholder="From Date">
                    <input type="date" class="form-control" id="toDatepicker" placeholder="To Date">
