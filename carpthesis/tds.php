...
var chart = new CanvasJS.Chart("chartContainer", {
    ...
    data: [{
        type: "line",
        dataPoints: <?php echo json_encode($TDSData, JSON_NUMERIC_CHECK); ?>
    }]
});
chart.render();
...
<div class="d-flex justify-content-center">
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#turnTDSon" style="margin: 45px;" id="turnOnButton">
        Turn on TDS
    </button>

    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#turnTDSoff" style="margin: 45px;" id="turnOffButton">
        Turn off TDS
    </button>
</div>

<!-- Modal -->
<div class="modal fade" id="turnTDSon" tabindex="-1" aria-labelledby="turnTDSonLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="turnTDSonLabel">Total Dissolved Solids Sensor Turned On</h1>
...
<!-- Modal -->
<div class="modal fade" id="turnTDSoff" tabindex="-1" aria-labelledby="turnTDSoffLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="turnTDSoffLabel">Total Dissolved Solids Sensor Turned Off</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
